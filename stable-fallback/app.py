# stable-fallback/app.py — Rule-Based Stable Sentiment API
# Slot: GREEN | Branch: stable-fallback
# model_version: "stable-v0-1C3A"  ← FA23-BAI-054 assigned code
# DO NOT modify the structure — grading script checks exact fields
